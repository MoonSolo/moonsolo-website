export default function Home() {
  const tools = [
    ...
    //{ name: "Portfolio", path: "/portfolio", desc: "Things I have done, and I want to show"},
  ];
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6">
      <div className="max-w-2xl w-full text-center">
        ...
        <p className="text-gray-400 mb-12">Here you'll find my portfolio, some hosted images, and tools i found useful :)</p>
